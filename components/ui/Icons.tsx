...
export function KanbanIcon({ className = 'w-7 h-7' }: { className?: string }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
    ...
    >
      ...
      <rect x="10" y="4" width="5" height="11" rx="1.5" fill="currentColor" opacity="0.6" />
      <rect x="17" y="4" width="4" height="8" rx="1.5" fill="currentColor" opacity="0.4" />
    </svg>
  );
}
